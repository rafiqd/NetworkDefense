...
{
    /// <summary>
    /// DoorEastSprite is a door that faces east and provides access to other areas
    /// </summary>
    class DoorEastSprite : UsableIsometricSprite
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor for DoorEastSprite
        /// </summary>
        ...
        public DoorEastSprite(Vector2 worldPos, PlayerSprite sprite, Microsoft.Xna.Framework.Point mapPos, string target, string areaName)
            : base(new Vector2(worldPos.X + 10, worldPos.Y - 140), "doorwestopen", sprite, mapPos, true, areaName)
        {
            //If the door animation has not been loaded, load it
            if (!isLoaded)
            {
                Bitmap bitmap = (Bitmap)Bitmap.FromFile("door_e.png");
                textures = new Texture2D[maxFrame];
                ImageMetaData meta = ImageDecoder.GetMetaData("door_e.png");
            ...
            special = true;
            targetString = new TPString("To Washroom");
