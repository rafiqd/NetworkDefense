...
namespace Game.Sprites
{
    ...
    class ButtonSprite : TPSprite
    {
        ...
        /// <summary>
        /// The rectangle that stores the position, width and height of the button
        /// </summary>
        ...
        /// <summary>
        /// The action(function) to perform when the button is clicked
        /// </summary>
        private Action buttonAction;
        /// <summary>
        /// The texture of the button when the mouse is on it
        /// </summary>
        private Texture2D mouseOverTexture;
        /// <summary>
        /// Boolean that indicates whether the text on the button is aligned center or not
        /// </summary>
        private bool centerText;
        /// <summary>
        /// Boolean that indicates whether the mouse is on the button or not
        /// </summary>
        private bool mouseOver;
        /// <summary>
        /// Boolean that indicates whether the button is disabled or not
        /// </summary>
        ...
        /// <summary>
        /// Changes the color overlay of the image.
        /// </summary>
        ...
        /// <summary>
        /// Set the position of the button and alignment the button text with it.
        /// </summary>
        public Vector2 Position
        {
            get { return new Vector2(drawRect.X, drawRect.Y); }
            set { drawRect.X = (int)value.X; drawRect.Y = (int)value.Y; setTextAlignment(); }
        }
